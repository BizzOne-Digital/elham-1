...
export function HeroBackdrop({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-void-black via-void-black/75 via-45% to-transparent to-85%" />
      <div className="absolute inset-0 bg-gradient-to-t from-void-black/50 via-transparent to-void-black/20" />
    </div>
  );
}
